...
func (in *PodConfigSpec) DeepCopyInto(out *PodConfigSpec) {
	*out = *in
	out.SampleDeployment = in.SampleDeployment
...
func (in *PodConfigStatus) DeepCopyInto(out *PodConfigStatus) {
	*out = *in
	if in.PodConfigurations != nil {
		in, out := &in.PodConfigurations, &out.PodConfigurations
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrunkPort) DeepCopyInto(out *TrunkPort) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrunkPort.
func (in *TrunkPort) DeepCopy() *TrunkPort {
	if in == nil {
		return nil
	}
	out := new(TrunkPort)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TrunkPort) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrunkPortList) DeepCopyInto(out *TrunkPortList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrunkPortList.
func (in *TrunkPortList) DeepCopy() *TrunkPortList {
	if in == nil {
		return nil
	}
	out := new(TrunkPortList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TrunkPortList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrunkPortSpec) DeepCopyInto(out *TrunkPortSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrunkPortSpec.
func (in *TrunkPortSpec) DeepCopy() *TrunkPortSpec {
	if in == nil {
		return nil
	}
	out := new(TrunkPortSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrunkPortStatus) DeepCopyInto(out *TrunkPortStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrunkPortStatus.
func (in *TrunkPortStatus) DeepCopy() *TrunkPortStatus {
	if in == nil {
		return nil
	}
	out := new(TrunkPortStatus)
	in.DeepCopyInto(out)
	return out
}
